...
void Shader::SetUniformMat4(const std::string& uniformName, bool transpose, const Mat4& mat)
{
    glUniformMatrix4fv(GetUniformLocation(this, uniformName), 1, transpose, mat.data);
}