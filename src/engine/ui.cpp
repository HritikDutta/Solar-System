...
void Init()
{
    ...
    glGenVertexArrays(1, &uiData.rectVAO);

    uiData.rectShader.LoadShader("res/shaders/rect.vert", Shader::Type::VERTEX_SHADER);
    uiData.rectShader.LoadShader("res/shaders/rect.frag", Shader::Type::FRAGMENT_SHADER);
    uiData.rectShader.Compile();

    uiData.fontShader.LoadShader("res/shaders/font.vert", Shader::Type::VERTEX_SHADER);
    uiData.fontShader.LoadShader("res/shaders/font.frag", Shader::Type::FRAGMENT_SHADER);
    uiData.fontShader.Compile();
...
void RenderRect(Application* app, const Rect& rect, Vec4 color, f32 layer)
{
    ...
    uiData.rectShader.Bind();
    uiData.rectShader.SetUniform2f("u_topLeft", left, top);
    uiData.rectShader.SetUniform2f("u_size",    sizeX, sizeY);
    uiData.rectShader.SetUniform1f("u_layer",   layer);
    uiData.rectShader.SetUniform4f("u_color",   color.r, color.g, color.b, color.a);

    glBindVertexArray(uiData.rectVAO);
